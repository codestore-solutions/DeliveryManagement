...
export {default as DashboardCard} from './common/DashboardCard/DashboardCard';
export {default as SingleDetail} from './common/SingleDetail/SingleDetail';
export {default as CustomButton}  from './common/CustomButton/CustomButton';
export {default as KycDetails}  from './KycDetails/KycDetails';
