...
import { manualAssignAgentInterface, previewDataInterface } from '../../utils/types';
...
const AutomaticAssign: React.FC<AutoProps> = ({
    orders,
    onClose,
  }) => {
...
const SingleAssign: React.FC<Props> = ({selectedRow, isOpen,handleCloseModal}) => {
